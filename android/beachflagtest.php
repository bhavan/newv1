...
$db = JFactory::getDBO();
$db->setQuery("SELECT * FROM #__content where id=153");
...
<head>
	...
	<title>Beach Flag Definitions</title>
...
<?php
/*
$redirect = "/index.php?option=com_content&view=article&tmpl=component&id=".);
