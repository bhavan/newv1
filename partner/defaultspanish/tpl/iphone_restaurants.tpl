...
?>
		<tr>
			...
			<?php if ($_REQUEST['bIPhone']=='0'){?>
				<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $row_featured[phone]); ?>">llamar</a> |     
			<?php } else { ?>
				<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $row_featured[phone]); ?>">llamar</a> |<?php } ?>
				...
				<a class="linktext" href="diningdetails.php?did=<?=$row_featured[loc_id]?>&<?=round($distance_featured,1)?>&lat=<?=$lat1?>&lon=<?=$lon1?>">>m&#225;s info</a> 
...
?>			
	<tr>
		...
		<tr><td class="graytext">
		<?php if ($_REQUEST['bIPhone']=='0'){?>
			<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $row[phone]); ?>">llamar</a> |     
		<?php } else { ?>
			<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $row[phone]); ?>">llamar</a> |<?php } ?>
...
if (($filter_loccat==0) || ($_REQUEST['filter_loccat']=='alp') && ($_POST['search_rcd']=="Buscar")) {
...
<tr>
	...
	<tr><td class="graytext">
	<?php if ($_REQUEST['bIPhone']=='0'){?>
	<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $data[phone]); ?>">llamar</a> |     
	<?php } else { ?>
	<a class="linktext" href="tel:<?php echo str_replace(array(' ','(',')','-','.'), '', $data[phone]); ?>">llamar</a> |
<?php 
	...
	<a class="linktext" href="javascript:linkClicked('APP30A:FBCHECKIN:<?php echo $data[geolat]; ?>:<?php echo $data[geolon]; ?>')">facturar</a> | 					
	<a class="linktext" href="diningdetails.php?did=<?=$data['loc_id']?>&lat=<?=$lat1?>&lon=<?=$lon1?>">m&#225;s info</a> 
