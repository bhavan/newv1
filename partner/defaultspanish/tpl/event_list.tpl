...
<div>
<div style='float:left;'><a class="button" href="events_submit.php" style="float:left;">Envíenos sus eventos</a></div>
...
<table>
  <tbody>
    ...
    if($DisplaySearchdate=='' || $DisplaySearchdate=='Search Events by Date'){
			...
			$end_date = date("Y-m-d", strtotime ("+80 day", strtotime($check_date)));
		}else{
