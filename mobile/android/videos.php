...
<div id="content">
	<ul class="pageitem">
     ...
     <a href="<?=$arr2[0]?>"><img src="/images/phocagallery/<?=$row['filename']?>" border="0" align="left" style="padding-right:10px;" /></a><font color="#999999"><strong><a href="<?=$arr2[0]?>"><img src="images/next-videos.gif" align="right" style="padding-top:20px;"  border="0"/></a>
