...
$query="select * from jos_content where id=171";
...
<div id="footer">
	...
	<a href="http://www.tapdestin.com">&copy; <?=date('Y")?> <?=$site_name?>, Inc.</a> | <a href="mailto:<?=$email?>?subject=<?=$site_name?> Information">Contact Us</a></div>
</body>
