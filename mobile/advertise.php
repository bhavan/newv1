...
<div id="wrapper">
	...
	<div id="my_area" style="padding:15px; width:680px;"><p>
		<iframe name="I1" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/index.php?option=com_rsform&formId=2&tmpl=component" width="650" height="750" frameborder="0" scrolling="no">
