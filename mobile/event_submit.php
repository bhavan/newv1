...
<div id="wrapper">
 ...
 {
 echo 'Thank you for submitting your event. Our team will review and promote your information as soon as possible! Please complete this form again to submit other events.';
 session_destroy();
 }
 ?></font></div>
   ...
   <table align="left" class="toolbar"><tbody><tr>
<td id="toolbar-save" class="">
<a onClick="javascript:submitbutton('icalevent.save');return false;;return false;" href="#" class="button">
Save
</a>
</td>

<td id="toolbar-cancel" class="">
