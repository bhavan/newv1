<h2>This Week in Tallahassee</h2>
<table>
  <tbody>
    <?php 
...
<a class="button" style="float:left;" href="http://www.tapdestin.com/event_submit.php?option=com_jevents&view=icalevent&task=icalevent.edit&Itemid=111&tmpl=component">Send Us Your Events</a>
<br clear="all" />