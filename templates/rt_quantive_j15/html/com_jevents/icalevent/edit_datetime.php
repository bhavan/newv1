...
?>
   <div style="clear:both;">
	...
	<span style="margin:20px" class='checkbox12h'>
		...
		<span><input type="hidden" id='view12Hour' name='view12Hour' <?php echo !$clock24 ?"checked='checked'":""; ?> onclick="toggleView12Hour();" value="1"/></span>
        ...
        <div style="float:left">
         ...
         <div style="float:left;margin-left:20px!important;">
			...
			<span id="start_12h_area" style="display:inline">
           	<input type="text" name="start_12h" id="start_12h" size="8" maxlength="8" <?php echo $this->row->alldayevent()?"disabled='disabled'":"";?> value="" onchange="check12hTime(this);" />
        ...
        <div style="float:left">
         ...
         <div style="float:left;margin-left:20px!important">
			...
			<span id="end_12h_area" style="display:inline">
           	<input type="text" name="end_12h" id="end_12h" size="8" maxlength="8" <?php echo ($this->row->alldayevent() || $this->row->noendtime())?"disabled='disabled'":"";?> value="" onchange="check12hTime(this);" />
