...
<div id="footer">&copy; <?=date('Y');?> Sandestin Golf and Beach Resort | <a href="mailto:<?=$email?>?subject=Feedback">Contact Us</a></div>
</body>
</html>
