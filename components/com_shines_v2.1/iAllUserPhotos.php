...
$action = "iAllUserPhotos";

$params = JComponentHelper::getParams("com_shines");
$redirect = "/indexiphone.php?option=com_phocagallery&view=category&tmpl=component&limit=60&id=".intval($params->get("phocaimagecat",1));

$redirect .= "&iphoneapp=1&images=1";
