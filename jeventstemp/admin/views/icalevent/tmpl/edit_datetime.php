   ...
   <div style="clear:both;">
    ...
    <div>
        ...
        <div style="float:left">
			...
			*/
			...
			JEVHelper::loadCalendar11("publish_up", "publish_up", $this->row->startDate(),$minyear, $maxyear, 'var elem = $("publish_up");checkDates(elem);fixRepeatDates();',"var elem = $('publish_up');checkDates(elem);", 'Y-m-d');
    ...
    <div>
        ...
        <div style="float:left">
			...
			$minyear = $params->get("com_earliestyear",1970);
			$maxyear = $params->get("com_latestyear",2150);
			JEVHelper::loadCalendar11("publish_down", "publish_down", $this->row->endDate(),$minyear, $maxyear, 'var elem = $("publish_down");checkDates(elem);',"var elem = $('publish_up');checkDates(elem);", 'Y-m-d');
