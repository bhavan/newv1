	...
	function banner( &$row, &$lists )
	{
		...
		function changeDisplayImage() {
			if (document.adminForm.imageurl.value !='') {
				document.adminForm.imagelib.src='../partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/banners/' + document.adminForm.imageurl.value;
			} else {
				document.adminForm.imagelib.src='partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/blank.png';
			}
		}
						...
						<td valign="top">
							...
							if (preg_match("#swf$#i", $row->imageurl)) {
								...
								<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" border="0" width="<?php echo $lists['width'];?>" height="<?php echo $lists['height'];?>">
									<param name="movie" value="../partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/banners/<?php echo $row->imageurl; ?>"><embed src="../partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/banners/<?php echo $row->imageurl; ?>" loop="false" pluginspage="http://www.macromedia.com/go/get/flashplayer" type="application/x-shockwave-flash"  width="<?php echo $lists['width'];?>" height="<?php echo $lists['height'];?>"></embed>
								</object>
								<?php
							} elseif (preg_match("#gif|jpg|png#i", $row->imageurl)) {
								?>
								<img src="../partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/banners/<?php echo $row->imageurl; ?>" name="imagelib" />
								<?php
							} else {
								?>
								<img src="partner/<?php echo $_SESSION['partner_folder_name'] ?>/images/blank.png" name="imagelib" />
								<?php
							}
							?>
						</td>
