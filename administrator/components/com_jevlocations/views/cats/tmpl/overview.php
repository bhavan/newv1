...
<table cellpadding="4" cellspacing="0" border="0" width="100%">
	<tr>
		<td align="left" width="100%">
			...
			<button onclick="document.getElementById('search').value='';this.form.getElementById('catid').value='-1';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
		</td>
		<td width="100%">
			<?php
			echo $this->catFilter();
    ...
    foreach ($this->cats as $cat) {
        ...
        <tr class="row<?php echo $k; ?>">
        	<td width="20" >
          	...
          	<td >
          		<a href="#edit" onclick="return listItemTask('cb<?php echo $i;?>','cats.edit')" title="<?php echo JText::_('JEV_CLICK_TO_EDIT'); ?>">
          		<?php echo $cat->title; ?>
          		</a>
          	</td>
			...
			<input type="text" name="order[]" size="5" value="<?php echo $cat->ordering; ?>" class="text_area" style="text-align: center" />
          	...
          	?>
          	<a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $i; ?>','<?php echo $cat->published ? 'cats.unpublish' : 'cats.publish'; ?>')"><img src="<?php echo $pathIMG . $img; ?>" width="12" height="12" border="0" alt="" /></a>
          	</td>
...
<input type="hidden" name="task" value="cats.list" />
