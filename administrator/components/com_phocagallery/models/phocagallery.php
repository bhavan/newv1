...
class PhocaGalleryCpModelPhocaGallery extends JModel
{
	...
	function &getData() {
		...
		#DD#
		$a = unserialize($this->_data->metadesc);
		$this->_data->username = isset($a['username']) ? $a['username'] : '';
		$this->_data->location = isset($a['location']) ? $a['location'] : '';
		$this->_data->metadescription = isset($a['metadescription']) ? $a['metadescription'] : '';
		#DD#
