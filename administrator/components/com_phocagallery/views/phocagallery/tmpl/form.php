...
<div class="col50"><div style="text-align:right"><?php echo $this->tmpl['enablethumbcreationstatus']; ?></div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td colspan="2">
				<input type="text" maxlength="250" size="32" id="username" name="username" value="<?php echo $this->items->username; ?>" class="text_area">
			</td>
		</tr>
				<tr>
					<td valign="middle" align="right" class="key">
					...
					<td colspan="2">
						<input type="text" maxlength="250" size="32" id="location" name="location" value="<?php echo $this->items->location; ?>" class="text_area">
					</td>
		</tr>
		<!--#DD#-->
		<tr>
			...
			<td colspan="2">
				<textarea cols="46" rows="4" id="metadescription" name="metadescription"><?php echo $this->items->metadescription; ?></textarea>
			</td>
		</tr>
